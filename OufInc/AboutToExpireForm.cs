...
namespace OufInc
{
    public partial class AboutToExpireForm : Form
    {
        EF_ADO localDB = new EF_ADO();
        DataTable dataTable;

        public AboutToExpireForm(  )
        {
            InitializeComponent();
        ...
        void updateView()
        {
            ...
            {
                ts.AddItems(localDB.Warehouses.Find(((ItemWVal)w).Value).WarehouseAboutToExpireItemsReport(dateTimePicker1.Value));
            }
